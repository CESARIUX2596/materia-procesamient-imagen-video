...
window.onload = function init()
{
    ...
    //// ---------------------------
    divide_tetrahedron(vertices[0], vertices[1], vertices[2], vertices[3], NumTimesToSubdivide);
...
function divide_tetrahedron(a, b, c, d, k) {
    ...
    if (k == 0) {
        ...
        divideTetra(a, ab, ac, ad, k);
        divideTetra(ab, b, bc, bd, k);
        divideTetra(ac, bc, c, cd, k);
        divideTetra(ad, bd, cd, d, k);
    }
}
